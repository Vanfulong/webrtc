...
cd WEBRTC-to-SIP
find . -type f -print0 | xargs -0 sed -i 's/72.69.99.146/PUT-IPV6-OF-YOUR-SIP-SERVER-HERE/g'
find . -type f -print0 | xargs -0 sed -i 's/69.18.218.111/PUT-IPV4-OF-YOUR-SIP-SERVER-HERE/g'
find . -type f -print0 | xargs -0 sed -i 's/voip3.operrtel.com/PUT-DOMAIN-OF-YOUR-SIP-SERVER-HERE/g'
```
...
## Testing
You should now be able to go to https://voip3.operrtel.com/ and call legacy SIP clients. Click the account icon in the top right corner and add the following settings:

- Display name: Whatever
- SIP URI: websip@voip3.operrtel.com
- Password: websip
- Outbound Proxy: wss://voip3.operrtel.com/ws
